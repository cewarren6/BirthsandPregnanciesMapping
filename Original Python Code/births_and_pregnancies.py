...
def dhsAsfrJoin(urbanAsfrFc, ruralAsfrFc, iso2, dhsRegionsFc, urbanAreasShp, iso3, outGDB):
    ...
    try:
        ...
        if int(arcpy.GetCount_management("in_memory/urbanAsfrExtract").getOutput(0)) == 0 and int(arcpy.GetCount_management("in_memory/ruralAsfrExtract").getOutput(0)) == 0:
            ...
            arcpy.Merge_management(["in_memory/dhsUrban", "in_memory/dhsRural"], outGDB + "/dhsAsfr%s" % iso3)
...
if __name__ == "__main__":
    ...
    # Input paths
    countryListXml = "C:/Projects/BirthsAndPregnanciesMapping/code/country_list.xml" # List of countries to process

    urbanAsfrFc = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/asfr.gdb/asfrURBAN" # Urban ASFR data
    ruralAsfrFc = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/asfr.gdb/asfrRURAL" # Rural ASFR data
    dhsRegionsFc = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/dhsBoundaries.gdb/subnational_boundaries" # DHS boundaries   
    urbanAreasShp = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/urban/af_as_lac_urban.shp" # Urban area extents
    ageFc = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/popByAgeGroup.gdb/africa" # Sub-national breakdown of population by age
    ageXls = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/POPULATION_BY_AGE_FEMALE.xls" # UN national breakdown of female population by age
    popRastDir = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/WorldPop" # Population raster directory
    grumpPopRast = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/GRUMP2010-global/grasafpd1k2010v2.tif" # GRUMP population raster
    unBirthsXls = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/All-countries-births-by-year.xls" # UN estimates of births
    birthPregMultiXlsx = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/Births-to-pregnancies-multipliers.xlsx" # Births to pregnancy multipliers
    countryBoundaries = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/lsib-wvs.gdb/detailed_world_polygons" # Country boundary polygons
    urbanGrowthFc = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/growthRates.gdb/Urban" # Urban growth rates
    ruralGrowthFc = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/growthRates.gdb/Rural" # Rural growth rates
    adminBoundaryFc = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/adminBoundaries.gdb/GAUL_2010_2" # Admin level 2 boundaries
    growthRatesXls = "C:/Projects/BirthsAndPregnanciesMapping/data/2014-05-23/WPP2012_POP_F02_POPULATION_GROWTH_RATE.XLS" # UN National Growth Rates

    # Output paths
    outDir = "C:/Projects/BirthsAndPregnanciesMapping/results/raster" # Raster output directory
    outGDB = "C:/Projects/BirthsAndPregnanciesMapping/results/vector.gdb" # Vector output geodatabase
    outXlsxDir = "C:/Projects/BirthsAndPregnanciesMapping/results/excel" # Excel output directory
